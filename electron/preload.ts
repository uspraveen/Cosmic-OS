...
contextBridge.exposeInMainWorld('cosmic', {
  ...
  setVoiceTypingShortcutEnabled: (enabled: boolean) =>
    ipcRenderer.invoke('voice:set-shortcut-enabled', enabled),
  ...
  getGatewaySchedulerOverview: () => ipcRenderer.invoke('gateway:get-scheduler-overview'),
  pauseGatewaySchedulerCron: (payload: any) => ipcRenderer.invoke('gateway:pause-scheduler-cron', payload),
  resumeGatewaySchedulerCron: (payload: any) => ipcRenderer.invoke('gateway:resume-scheduler-cron', payload),
  deleteGatewaySchedulerCron: (payload: any) => ipcRenderer.invoke('gateway:delete-scheduler-cron', payload),
  pauseGatewaySchedulerHeartbeat: (payload: any) => ipcRenderer.invoke('gateway:pause-scheduler-heartbeat', payload),
  ...
  getGatewayZcodeStatus: () => ipcRenderer.invoke('gateway:get-zcode-status'),
  saveGatewayZcodeConfig: (payload: any) => ipcRenderer.invoke('gateway:save-zcode-config', payload),
  startGatewayZcodeLogin: () => ipcRenderer.invoke('gateway:start-zcode-login'),
  logoutGatewayZcode: () => ipcRenderer.invoke('gateway:logout-zcode'),
  ...
  getGatewayOpenCodeCatalog: (opts?: { forceRefresh?: boolean }) =>
    ipcRenderer.invoke('gateway:get-opencode-catalog', opts || {}),
  getGatewayOpenCodeProviders: () => ipcRenderer.invoke('gateway:get-opencode-providers'),
  connectGatewayOpenCodeProvider: (payload: { providerId: string; apiKey: string }) =>
    ipcRenderer.invoke('gateway:connect-opencode-provider', payload),
  disconnectGatewayOpenCodeProvider: (providerId: string) =>
    ipcRenderer.invoke('gateway:disconnect-opencode-provider', providerId),
  ...
  listGatewayToolOpportunities: () => ipcRenderer.invoke('gateway:list-tool-opportunities'),
  updateGatewayToolOpportunity: (payload: any) => ipcRenderer.invoke('gateway:update-tool-opportunity', payload),
  buildGatewayToolOpportunity: (opportunityId: string) => ipcRenderer.invoke('gateway:build-tool-opportunity', opportunityId),
  ...
  vaultApprovePending: (requestId: string, payload?: { grant?: 'once' | 'window' | 'always'; window_seconds?: number }) =>
  ...
  updateGatewayGmailApprovalDraft: (payload: any) => ipcRenderer.invoke('gateway:update-gmail-approval-draft', payload),
  approveGatewayAgentEmailApproval: (payload: any) => ipcRenderer.invoke('gateway:approve-agent-email-approval', payload),
