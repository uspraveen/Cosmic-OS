    ...
    ToolSpec(
        ...
        api_definition={
            ...
            "description": (
                ...
                "idempotency key. The user may pause a live run and drive the browser themselves; each "
                "handover appears in `takeovers` with what they changed, and page state afterwards is "
                "their work, not the agent\'s - never redo it. A run that reaches its step ceiling asks to continue and is granted "
