...
- Parsed document surfaces may already contain inline figure descriptions and page or slide markers. Use `docs_fetch_asset` when exact figure, table, page-image, or slide-image evidence matters, and do not claim you visually inspected an asset unless you actually fetched it or read the relevant parsed description.
