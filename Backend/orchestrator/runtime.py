...
class OrchestratorRuntime:
    ...
    def _with_fireworks_kimi_runtime_note(system_prompt: str) -> str:
        note = (
            ...
            "Do not use `cosmic_code_execution` to generate maps, route visuals, geocoding displays, shape overlays, or Folium/HTML map files when the user expects an inline map; search the specialist catalog and delegate to `map.render` because it returns COSMIC inline map artifacts. "
