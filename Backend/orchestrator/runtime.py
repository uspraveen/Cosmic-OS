    ...
    async def _answer_interrupt_with_model(
        ...
        *,
        ...
        system_prompt = (
            ...
            "1. Answer from CONTEXT only. You may translate a fact into the choice it "
            "unambiguously determines (for example: 'No pets / no assistance animals' "
            "means the no-pet profile option), but never invent, approximate, or add "
            "personal data that is not present.\n"
            ...
            "escalate instead.\n"
            "3. If the answer cannot be derived from CONTEXT with certainty, escalate.\n"
