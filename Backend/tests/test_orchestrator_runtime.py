...
async def test_orchestrator_runtime_streams_fireworks_glm_text_path() -> None:
    ...
    assert streamed_events[0]["legacy_route"] == "opus"
    assert streamed_events[0]["dispatch_target"] == "orchestrator"
    ...
    assert complete["legacy_route"] == "opus"
    assert complete["dispatch_target"] == "orchestrator"
