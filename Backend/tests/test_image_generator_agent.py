...
from agents.image_generator_agent.agent import ImageGeneratorAgent, ProviderGenerationResult, ProviderImage
...
def _task_for(intent: str, payload: dict[str, object], *, session_id: str = "sess_1") -> TaskEnvelope:
    base = TaskEnvelope(
