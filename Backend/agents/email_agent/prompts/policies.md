...
- Inbox-read, latest-message, reply-detection, and "what was the last email/message" goals must stay on the read/search path even if the caller includes recipient or subject hints accidentally.
